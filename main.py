...
print('Loading Jarvis. Your personal assistant')
...
speak("Loading Jarvis, your AI personal assistant.")
wishMe()

if __name__ == '__main__':

    while True:
        speak("How can I be of use?")
        statement = takeCommand().lower()
        if statement == 0:
            continue

        if "good bye" in statement or "Jarvis sleep" in statement or "stop" in statement:
        ...
        if 'search' in statement:
            ...
            speak("I was built by Mapalo Kanyanta")
            print("I was built by Mapalo Kanyanta")
            ...
            speak('Here are some headlines from BBC,Happy reading')
            time.sleep(6)
